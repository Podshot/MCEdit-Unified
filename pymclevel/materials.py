...
def build_pocket_materials():
    ...
    pocketMaterials.StandingBanner = pocketMaterials[176, 0]
    pocketMaterials.WallBanner = pocketMaterials[177, 0]
    pocketMaterials.DaylightSensorOn = pocketMaterials[178, 0]

    pocketMaterials.RedSandstone = pocketMaterials[179, 0]
    pocketMaterials.RedSandstoneStairs = pocketMaterials[180, 0]
    pocketMaterials.DoubleStoneSlab2 = pocketMaterials[181, 0]
    pocketMaterials.StoneSlab2 = pocketMaterials[182, 0]
    ...
    pocketMaterials.HardGlassPane = pocketMaterials[190, 0]
    pocketMaterials.HardStainedGlassPane = pocketMaterials[191, 0]
    pocketMaterials.ChemicalHeat = pocketMaterials[192, 0]
    pocketMaterials.SpruceDoor = pocketMaterials[193, 0]
    pocketMaterials.BirchDoor = pocketMaterials[194, 0]
    pocketMaterials.JungleDoor = pocketMaterials[195, 0]
    pocketMaterials.AcaciaDoor = pocketMaterials[196, 0]
    pocketMaterials.DarkOakDoor = pocketMaterials[197, 0]

    pocketMaterials.GrassPath = pocketMaterials[198, 0]
    pocketMaterials.ItemFrame = pocketMaterials[199, 0]

    pocketMaterials.ChorusFlower = pocketMaterials[200, 0]
    pocketMaterials.PurpurBlock = pocketMaterials[201, 0]
    pocketMaterials.ColoredTorchRg = pocketMaterials[202, 0]
    pocketMaterials.PurpurStairs = pocketMaterials[203, 0]
    pocketMaterials.ColoredTorchBp = pocketMaterials[204, 0]
    pocketMaterials.UndyedShulkerBox = pocketMaterials[205, 0]
    pocketMaterials.EndBricks = pocketMaterials[206, 0]
    pocketMaterials.FrostedIce = pocketMaterials[207, 0]
    pocketMaterials.EndRod = pocketMaterials[208, 0]
    pocketMaterials.EndGateway = pocketMaterials[209, 0]
    pocketMaterials.Magma = pocketMaterials[213, 0]
    pocketMaterials.NetherWartBlock = pocketMaterials[214, 0]
    pocketMaterials.RedNetherBrick = pocketMaterials[215, 0]
    pocketMaterials.BoneBlock = pocketMaterials[216, 0]
    pocketMaterials.ShulkerBox = pocketMaterials[218, 0]
    pocketMaterials.PurpleGlazedTerracotta = pocketMaterials[219, 0]
    pocketMaterials.WhiteGlazedTerracotta = pocketMaterials[220, 0]
    pocketMaterials.OrangeGlazedTerracotta = pocketMaterials[221, 0]
    pocketMaterials.MagentaGlazedTerracotta	 = pocketMaterials[222, 0]
    pocketMaterials.LightBlueGlazedTerracotta = pocketMaterials[223, 0]
    pocketMaterials.YellowGlazedTerracotta = pocketMaterials[224, 0]
    pocketMaterials.LimeGlazedTerracotta = pocketMaterials[225, 0]
    pocketMaterials.PinkGlazedTerracotta = pocketMaterials[226, 0]
    pocketMaterials.GrayGlazedTerracotta = pocketMaterials[227, 0]
    pocketMaterials.SilverGlazedTerracotta = pocketMaterials[228, 0]
    pocketMaterials.CyanGlazedTerracotta = pocketMaterials[229, 0]
    pocketMaterials.BlueGlazedTerracotta = pocketMaterials[231, 0]
    pocketMaterials.BrownGlazedTerracotta = pocketMaterials[232, 0]
    pocketMaterials.GreenGlazedTerracotta = pocketMaterials[233, 0]
    pocketMaterials.RedGlazedTerracotta = pocketMaterials[234, 0]
    pocketMaterials.BlackGlazedTerracotta = pocketMaterials[235, 0]
    pocketMaterials.Concrete = pocketMaterials[236, 0]
    pocketMaterials.ConcretePowder = pocketMaterials[237, 0]
    pocketMaterials.ChemistryTable = pocketMaterials[238, 0]
    pocketMaterials.UnderwaterTorch = pocketMaterials[239, 0]
    pocketMaterials.ChorusPlant = pocketMaterials[240, 0]
    pocketMaterials.StainedGlass = pocketMaterials[241, 0]
    ...
    pocketMaterials.MovingBlock = pocketMaterials[250, 0]
    pocketMaterials.Observer = pocketMaterials[251, 0]
    pocketMaterials.StructureBlock = pocketMaterials[252, 0]
    pocketMaterials.HardGlass = pocketMaterials[253, 0]
    pocketMaterials.HardStainedGlass = pocketMaterials[254, 0]
    pocketMaterials.info_reserved6 = pocketMaterials[255, 0]
    pocketMaterials.PrismarineStairs = pocketMaterials[257, 0]
