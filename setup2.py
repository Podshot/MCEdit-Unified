# setup2.py
# setup.py modified by D.C.-G.
# Script used to compile MCEdit for my own purpose. If it can help someone...
...
def main():
    ...
    include_dirs = ['fonts', 'toolicons', 'stock-schematics', 'stock-filters']
    data_files = get_data_files(include_dirs) + [
        ...
        ('pymclevel', [os.path.join('pymclevel', a) for a in [
                                                             'classic.yaml',
                                                             'indev.yaml',
                                                             'minecraft.yaml',
                                                             'pocket.yaml',
...
#                "includes": ["ctypes", "logging", "OpenGL"],
                ...
                # "excludes": ["OpenGL"]
                "excludes": [],
                "dist_dir": os.path.join("..", "..", "dist", "1.1.2.0"),
            }
        }
    )
