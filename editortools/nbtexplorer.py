...
map_block = {}
for k, v in block_map.iteritems():
    map_block[v] = k

from pymclevel.items import items as mcitems

map_items = {}
for k, v in mcitems.items.iteritems():
    if isinstance(v, dict):
        ...
        if isinstance(v['name'], list):
            ...
            names = [v['name']]
        for name in names:
            if not (name is None or name in map_items.keys()):
        ...
        if types_item is None:
            ...
            if parent:
                ...
                if p_type == TAG_List:
                    ...
                    v = None
                    for key, value in item_types_map.iteritems():
